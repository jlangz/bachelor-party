# Supabase data structure instructions
...
CREATE INDEX idx_recommendation_comments_recommendation_id ON recommendation_comments(recommendation_id);
...
CREATE INDEX idx_user_prediction_stats_user_id ON user_prediction_stats(user_id);
...
After running the schema, you can add a test admin user:
