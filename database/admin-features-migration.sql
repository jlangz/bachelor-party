...
-- Only admins can read and update their own passwords
...
-- Insert default activities (migrating from hardcoded ones)
INSERT INTO activities (name, description, activity_type, participation_options, display_order, is_active) VALUES
  (
    'Shooting Range',
    'Gun range activity - participate or watch',
    'mixed',
    '["participating", "watching", "not_attending"]',
    1,
    true
  ),
  (
...
-- ============================================
SELECT
  'Admin features migration completed!' as message,
